...
mathjax: false
toc: true
date: 2017-11-01 22:17:35
---

本文主要是记录使用基于 MXNet 的高层接口 Gluon 训练 CIFAR-10 图像分类的练习。
...
- [使用Gluon对原始图像文件分类](http://zh.gluon.ai/chapter_computer-vision/kaggle-gluon-cifar10.html)